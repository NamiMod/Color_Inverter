...
int main(int argc, char *argv[]) {
     ...
     *
     *
     * NOTICE !!! : if you change the image at "line 25" you should also change the image in 'bitmap.c' at "line 22" *
     *
     *
     */
    int fd = open("sample.bmp", O_RDWR);
